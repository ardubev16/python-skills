...
description: Use when starting a new Python project, or when an existing project needs to be converted into a proper installable package. Scaffolds a uv-managed package (src layout, hatch-vcs versioning) with .python-version, .editorconfig, .gitignore and direnv support.
---
...
- This skill only covers scaffolding. For linting/formatting/type-checking
  ...
  `python-ci-docker`. For picking third-party libraries, see
